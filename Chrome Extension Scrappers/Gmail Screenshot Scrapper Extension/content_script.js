...
if (location.href.indexOf('https://mail.google.com/') > -1) {


/* Main function call */
$(document).ready(function () {
    setTimeout(function(){
        var title = document.querySelector(".adn.ads .gs > div span.gD").textContent.replace(/\s/g , "-");
        var message_box= document.querySelector("div.hj");
       // message_box.appendChild("<span id='alert_box' style='color:royalblue;'>Downloading . . .   </span>");
        html2canvas(document.querySelector(".adn.ads .gs > div:last-of-type"),
            {
                allowTaint: true,
                useCORS: true
            }).then(function (canvas) {
                var anchorTag = document.createElement("a");
                anchorTag.download = "Image-"+title+".png";
                anchorTag.href = canvas.toDataURL();
                anchorTag.target = '_blank';
                anchorTag.click();
            }).catch(function(e) {
                message_box.innerHTML =("<span id='alert_box' style='color:crimson;'>Could not download  </span>");
            });
...
/* Function html2canvas  End */

}else{
    alert('Only take screenshot for gmail promotions ');
    }
}
