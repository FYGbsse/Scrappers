(function ($) {
    ...
    var halo = {
        ...
        initMobileMenuDefault: function(url) {
            ...
            var nav = '';
            if($('body').hasClass('sweet-july-skin')) {
              nav = $('.Skin-Header #HeaderNavigation [data-navigation]');
            }
            else {
              nav = $('#HeaderNavigation [data-navigation]');
            }
...
// var links = document.links;
// for (let i = 0, linksLength = links.length; i < linksLength; i++) {
//   // Check if the link is not within the .nav_menu class
//   if (!links[i].closest('#HeaderNavigation')) {
//     if (links[i].hostname !== window.location.hostname) {
//       links[i].target = '_blank';
//       links[i].rel = 'noreferrer noopener';
//     }
...
$(document).ready(function () {
  $(".collection-default .halo-collection-content .page-sidebar .sidebarBlock-content .all-categories-list .navPages-item").click(function () {
    //$(".collection-default .halo-collection-content .page-sidebar .sidebarBlock-content .all-categories-list .navPages-item").addClass("Collection-active");
      $(this).toggleClass("Collection-active");
  });

  var elementToMove = $('.station-tabs-local-above');
  var targetElement = $('.productView-price');
  
  // Make sure both elements exist on the page before moving
  if (elementToMove.length > 0 && targetElement.length > 0) {
...
$(document).ready(function () {
if($('.cart-item').length){
    $('.cart-item:contains("Donation")').hide();
}
// if($('li.product').length){
//     $('li.product:contains("Donation")').hide();
// }
});
